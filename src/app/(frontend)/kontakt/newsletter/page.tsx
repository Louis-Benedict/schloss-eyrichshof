...
export default function NewsletterPage() {
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <h1 className="text-4xl font-light mb-4">Newsletter</h1>
      <p className="text-warm-600 leading-relaxed mb-8">
        Bleiben Sie über Veranstaltungen, Neuigkeiten und besondere Angebote auf Schloss
        Eyrichshof informiert. Melden Sie sich für unseren Newsletter an.
      </p>
