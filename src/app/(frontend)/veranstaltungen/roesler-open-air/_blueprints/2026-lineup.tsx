// Blueprint — the full 2026 edition (lineup, JSON-LD, ticket links) before it was replaced by
// the "lineup coming soon" version for 2027 in ../page.tsx. Not a route (private `_` folder):
// copy the relevant parts back into page.tsx once the 2027 lineup is confirmed.
        ...
        <div className="lg:flex lg:gap-14">
          ...
          <aside className="hidden lg:block w-64 shrink-0">
            <div className="sticky top-24 bg-warm-100 p-6">
              {/* Ticket box */}
              <p className="text-[11px] uppercase tracking-[0.2em] text-warm-400 mb-1">Sommer 2026</p>
              <p className="font-heading text-xl text-brand mb-5">30. Juli – 4. August 2026</p>

              <a
                href="https://www.kartenkiosk-bamberg.de"
                target="_blank"
                rel="noopener"
                className="block w-full text-center py-3 bg-accent hover:bg-accent-hover text-white text-sm uppercase tracking-widest transition-colors mb-6"
              >
                Tickets buchen
              </a>
