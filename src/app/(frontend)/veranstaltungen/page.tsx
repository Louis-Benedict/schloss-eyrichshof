        ...
        >
          ...
          <div className="absolute inset-x-0 bottom-0 p-8 sm:p-12">
            <div className="flex flex-wrap items-center gap-2 mb-4">
              <span className="text-[11px] uppercase tracking-[0.16em] bg-accent text-white px-2.5 py-1 font-medium">
                {hero.dates}
              </span>
              {hero.tag && (
                <span className="text-[11px] uppercase tracking-[0.16em] bg-white/20 text-white px-2.5 py-1 backdrop-blur-sm">
                  {hero.tag}
                </span>
              )}
            </div>
            ...
            <p className="text-warm-100 text-base leading-relaxed mb-6 max-w-xl">
              {hero.description}
            </p>
          ...
          {rest.map((event) => (
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 p-7">
                ...
                <p className="text-warm-100 text-sm leading-relaxed mb-4 max-w-xs opacity-0 translate-y-1 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
                  {event.description}
                </p>
