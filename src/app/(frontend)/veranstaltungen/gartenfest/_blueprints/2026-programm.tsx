// Blueprint — the full 2026 "Programm" (day-by-day schedule, `tage`) and "Ganztags" (recurring
// all-day exhibitors, `ganztags`) sections before they were removed from ../page.tsx as no
// longer accurate. Not a route (private `_` folder): copy the relevant parts back into
// page.tsx once the 2027 programme is confirmed.
