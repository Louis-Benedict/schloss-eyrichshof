...
export default function SchlossNav({ currentHref }: { currentHref: string }) {
  const others = schlossPages.filter((p) => p.href !== currentHref)

  return (
    <section className="border-t border-warm-200 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <p className="text-xs uppercase tracking-[0.22em] text-accent mb-8">Mehr über das Schloss</p>
